...
impl CommandOpt {
    pub fn new(
        ...
        pargs: Vec<String>,
        out_dir: &Path,
        main_data: (String, Vec<String>),
        track_data: (String, Vec<String>),
        search_method: &str,
        mut mem_limit: u64,
        time_limit: u64,
        enable_afl: bool,
        ...
        let uses_asan = check_dep::check_asan(&main_data.0);
        ...
        Self {
            mode,
            id: 0,
            main: (main_data.0, main_data.1),
            track: (track_data.0, track_data.1),
            tmp_dir,
            out_file: out_file,
            // forksrv_socket_path,
            track_path,
